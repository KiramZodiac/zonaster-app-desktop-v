const Terms = [
  { title: "Version 1.0", description: [] },
  {
    title: "Last updated: June 09, 2022",
    description: [
      `The www.zonaster.com website located at https://www.zonaster.com is a copyrighted work belonging to Zonaster Inc. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.`,
  ...
  },
  {
    ...
    description: [
      `Like any other website, www.zonaster.com uses ‘cookies’. These cookies are used to store information including visitors’ preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users’ experience by customizing our web page content based on visitors’ browser type and/or other information.`,
      `Disclaimers`,
  ...
  },
  {
    ...
    description: [
      `Before either party may seek arbitration, the party must first send to the other party a written Notice of Dispute describing the nature and basis of the claim or dispute, and the requested relief.  A Notice to the Company should be sent to: Kyamogo, Kaduyu Lane, KL-15. After the Notice is received, you and the Company may attempt to resolve the claim or dispute informally.  If you and the Company do not resolve the claim or dispute within thirty (30) days after the Notice is received, either party may begin an arbitration proceeding.  The amount of any settlement offer made by any party may not be disclosed to the arbitrator until after the arbitrator has determined the amount of the award to which either party is entitled.`
    ]
  },
  {
  ...
  {
    title: "Claims Not Subject to Arbitration.",
    description: [
  ...
  { title: "Your Privacy.", description: [`Please read our Privacy Policy.`] },
  {
  ...
  },
  {
    ...
    description: [
      `Address: Kyamogo, Kaduyu Lane, KL-15`,
      `Email: zonaster256@gmail.com`
    ]
  }
];
